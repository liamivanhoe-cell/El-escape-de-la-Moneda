...
export const CHARACTERS: Character[] = [
  ...
  },
  {
    ...
    type: 'coin',
    value: 1,
    color: 'bg-gray-300', // Changed to silver base if image fails loading
    borderColor: 'border-gray-400', // Standard silver coin
    textColor: 'text-gray-900',
    isLocked: false,
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c8/Un_Sol_2012_Anverso.png/240px-Un_Sol_2012_Anverso.png' // Image for 1 Sol
  },
  {
    id: 's2',
